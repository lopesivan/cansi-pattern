...
__CHEETAH_genTime__ = 1511303758.823078
__CHEETAH_genTimestamp__ = 'Tue Nov 21 20:35:58 2017'
__CHEETAH_src__ = '../m/StartedState_c.tmpl'
__CHEETAH_srcLastModified__ = 'Tue Nov 21 20:35:16 2017'
        ...
        write(u'''StatePtr state)
{
    ...
    ''')
        ...
        write(u''' (state);
    state->''')
        _v = VFN(VFFSL(SL,"state.start.to",True),"lower",False)() # u'${state.start.to.lower()}' on line 25, col 12
        if _v is not None: write(_filter(_v, rawExpr=u'${state.start.to.lower()}')) # from line 25, col 12.
        write(u''' = ''')
        _v = VFFSL(SL,"state.start.to",True) # u'${state.start.to}' on line 25, col 40
        if _v is not None: write(_filter(_v, rawExpr=u'${state.start.to}')) # from line 25, col 40.
        _v = VFN(VFFSL(SL,"state.name",True),"capitalize",False)() # u'${state.name.capitalize()}' on line 25, col 57
        if _v is not None: write(_filter(_v, rawExpr=u'${state.name.capitalize()}')) # from line 25, col 57.
        write(u''';
    /*state->func = ''')
        _v = VFFSL(SL,"state.start.to",True) # u'${state.start.to}' on line 26, col 21
        if _v is not None: write(_filter(_v, rawExpr=u'${state.start.to}')) # from line 26, col 21.
        _v = VFN(VFFSL(SL,"state.name",True),"capitalize",False)() # u'${state.name.capitalize()}' on line 26, col 38
        if _v is not None: write(_filter(_v, rawExpr=u'${state.name.capitalize()}')) # from line 26, col 38.
        write(u''';*/
}
...
if not hasattr(StartedState_c, '_initCheetahAttributes'):
    templateAPIClass = getattr(StartedState_c, '_CHEETAH_templateClass', Template)
